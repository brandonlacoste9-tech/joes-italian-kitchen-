...
const STORAGE_KEY = 'joes-italian-ambiance';
  ...
  useEffect(() => {
    ...
    async function start() {
      ...
      try {
        ...
        /* browsers block until a gesture */
      }
      if (mutedRef.current) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 left-4 z-40 border border-gold bg-night/95 px-3 py-2 text-sm tracking-wide text-cream md:left-6"
      >
